...
export async function installLib({catalogBytes,lockBytes,lockSha256,destination,mirror='github',catalogAuthority=catalogAuthorities.v009},fetcher=globalThis.fetch) {
