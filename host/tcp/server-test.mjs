...
const native=spawn(process.argv[2],[libPath,String(cases.length),appPath],{env:{},stdio:['ignore','pipe','pipe']});
let out='',err='',ready;
...
const smoke=spawn(process.argv[3],[libPath,appPath],{env:{},stdio:['ignore','pipe','pipe']});
