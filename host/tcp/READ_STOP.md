...
node host/tcp/fault-test.mjs host/lib-e2e/rust/target/release/tcp-stop-reference
bun host/tcp/fault-test.mjs host/lib-e2e/rust/target/release/tcp-stop-reference
deno run --allow-net=127.0.0.1 --allow-env=NODE_V8_COVERAGE \
  --allow-run=host/lib-e2e/rust/target/release/tcp-stop-reference \
  host/tcp/fault-test.mjs host/lib-e2e/rust/target/release/tcp-stop-reference
```
