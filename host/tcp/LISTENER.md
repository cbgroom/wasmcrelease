...
bun host/tcp/server-test.mjs host/lib-e2e/rust/target/release/tcp-server-reference host/lib-e2e/rust/target/release/resident-app-reference
mkdir -p target/host-tcp-app
deno run --allow-net=127.0.0.1 --allow-read=current,host/lib-e2e,libs/wasmc-owned-algorithms,target \
  --allow-write=target/host-tcp-app --allow-env=NODE_V8_COVERAGE \
  --allow-run=host/lib-e2e/rust/target/release/tcp-server-reference,host/lib-e2e/rust/target/release/resident-app-reference \
  host/tcp/server-test.mjs host/lib-e2e/rust/target/release/tcp-server-reference host/lib-e2e/rust/target/release/resident-app-reference
```
