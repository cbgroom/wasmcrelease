...
```sh
node host/tcp/driver-retirement-test.mjs
bun host/tcp/driver-retirement-test.mjs
deno run host/tcp/driver-retirement-test.mjs
node host/tcp/driver-retirement-test.mjs --real-tcp
bun host/tcp/driver-retirement-test.mjs --real-tcp
deno run --allow-net=127.0.0.1 host/tcp/driver-retirement-test.mjs --real-tcp
```
