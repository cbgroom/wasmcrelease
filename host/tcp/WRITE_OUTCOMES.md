...
node host/tcp/write-test.mjs host/lib-e2e/rust/target/release/tcp-write-reference
bun host/tcp/write-test.mjs host/lib-e2e/rust/target/release/tcp-write-reference
deno run --allow-net=127.0.0.1 --allow-env=NODE_V8_COVERAGE \
  --allow-run=host/lib-e2e/rust/target/release/tcp-write-reference \
  host/tcp/write-test.mjs host/lib-e2e/rust/target/release/tcp-write-reference
```
