...
const app=await createResidentApp(await readFile(new URL('libs/wasmc-owned-algorithms/artifact.wasm',root)),await compile(await readFile(new URL('host/lib-e2e/guest.wasmc',root),'utf8')));
let controls=0;
try {
