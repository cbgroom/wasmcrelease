...
with the caller. Guards are fresh per admitted owner. Owner tickets are
...
retry/replay. Failed normal `release` outside a failed-stop path and unexpected
guard faults still require deployment-supervisor containment; this reference
