...
```sh
cargo test --release --locked --manifest-path host/runtime/completion/rust/Cargo.toml
...
rotation denial. See ../../runtime/completion/LIFETIME.md. This is not RSS/leak proof. Native
