...
```sh
node host/drivers/udp/test.mjs
node host/drivers/udp/fault-test.mjs
cargo build --release --locked --manifest-path host/tests/e2e/rust/Cargo.toml
node host/drivers/udp/native-test.mjs host/tests/e2e/rust/target/release/udp-server-reference
```
