...
const app=await createResidentApp(await readFile('libs/wasmc-owned-algorithms/artifact.wasm'),await compile(await readFile('host/tests/e2e/guest.wasmc','utf8')));
