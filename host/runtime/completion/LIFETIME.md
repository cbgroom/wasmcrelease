...
are discarded and replaced by fresh CSPRNG scopes; see ../../drivers/tcp/GUARD_POOL.md.
...
Run `node host/runtime/completion/lifetime-test.mjs` (also Bun or permission-free Deno).
...
Rust `cargo test --release --locked --manifest-path host/runtime/completion/rust/Cargo.toml`
