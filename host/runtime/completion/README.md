...
race proof. Existing `host/tests/e2e` uses the guard around its real file read then
...
node host/runtime/completion/test.mjs host/runtime/completion/rust/target/release/wasmc-completion-guard
```
