...
```
cargo build --locked --manifest-path host/contract/v0/rust/Cargo.toml
node host/contract/v0/test.mjs host/contract/v0/rust/target/debug/wasmc-host-contract-reference
node host/contract/v0/core-test.mjs host/contract/v0/rust/target/debug/wasmc-host-contract-reference
```
...
```sh
cargo build --release --locked --manifest-path host/contract/v0/rust/Cargo.toml --features wasmtime-engine
node host/contract/v0/core-test.mjs host/contract/v0/rust/target/release/wasmc-host-contract-reference
